...
var modelList = [
            {
                name: "mesh.obj", url: 'http://10.100.82.65/viewer/mesh.obj'
            },
//            {
//                name: "crash2.obj", url: 'file:///android_asset/flutter_assets/assets/sample_models/crash2.obj'
//            },
            {
                name: "bear-obj.obj", url: 'http://10.100.82.65/viewer/sample_models/mesh.obj'
            },
            {
                name: "car2.obj", url: 'http://10.100.82.65/viewer/sample_models/tiger.obj'
                //, objectRotation: new THREE.Euler(0, 3 * Math.PI / 2, 0)
            },
            {
                name: "Tiger.obj", url: 'http://10.100.82.65/viewer/sample_models/wolf.obj'
            },
            {
                name: "Dinosaur_V02.obj", url: 'http://10.100.82.65/viewer/sample_models/Dinosaur_V02.obj'
            },
            {
                name: "skeleton.obj", url: 'http://10.100.82.65/viewer/sample_models/hand.obj'
            }
